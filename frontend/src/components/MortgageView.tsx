...
import { Home, TrendingUp, DollarSign, Calendar, Building2, PiggyBank, Download } from 'lucide-react';
import { generateMortgagePDF } from '../lib/pdfGenerator';
...
export default function MortgageView() {
  ...
  const handleDownloadPDF = () => {
    ...
    generateMortgagePDF({
      bankName,
      propertyValue: calculations.propertyValue,
      ...
      monthlyPaymentWithExtra: calculations.monthlyPaymentWithExtra,
